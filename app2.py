...
file_path = 'drug_nomenclature_and_modifications.xlsx'  # Update with your file path
...
if target_receptor:
    ...
    if not filtered_df.empty:
        ...
        # Display the molecular structure using PubChem
        if smiles:
        ...
        if st.button("Check for Side Effects"):
            ...
            for side_effect, modification, mod_smiles in zip(side_effects, modifications, modified_smiles):
                ...
                # Display the modified molecular structure using PubChem
                if mod_smiles:
